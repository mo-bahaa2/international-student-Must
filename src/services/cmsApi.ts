  ...
  { title: 'Home', url: '/', target: '_self', accessRole: 'public', children: [] },
  {
    ...
    children: [
      ...
      { title: 'E-Learning', url: '/e-learning', target: '_self', accessRole: 'public', children: [] },
      {
        ...
        accessRole: 'public',
        children: [
          { title: 'Required Documents', url: '/how-to-apply#required-documents', target: '_self', accessRole: 'public', children: [] },
          { title: 'How to Apply', url: '/how-to-apply#how-to-apply', target: '_self', accessRole: 'public', children: [] },
          { title: 'External Transfer Requirements', url: '/how-to-apply#external-transfer-requirements', target: '_self', accessRole: 'public', children: [] },
        ],
      },
      // { title: 'Student Handbook', url: '/handbook', target: '_self', accessRole: 'public', children: [] },
    ],
  },
